...
def enumerate_env() -> Optional[str]:
    """
    Return a path for the ${pwd}/.env.example.example file.
    ...
    try:
        ...
        return None
    path = os.path.join(cwd, ".env.example.example")
    return path
...
@click.option(
    ...
    help="Location of the .env.example.example file, defaults to .env.example.example file in current working directory.",
)
@click.option(
    "-q",
    "--quote",
...
def cli(ctx: click.Context, file: Any, quote: Any, export: Any) -> None:
    """This script is used to set, get or unset values from a .env.example.example file."""
...
@click.option(
    ...
    default=True,
    help="Override variables from the environment file with those from the .env.example.example file.",
)
